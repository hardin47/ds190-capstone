...
* Your peers
* You, months earlier, in August 2026
...
* Do not try to tell your audience everything.
...
* slow down
* keep ideas simple
* present only one (or two?) idea(s)
...
FIRST: introduce yourself to your neighbor


* Describe the rows and columns of your dataset.
   - What is a row? That is, how can you describe in words what is the observational unit? Do you have multiple datasets that have different observational units?
   - What are the columns? Which ones do you already know? How many columns are there that you haven't yet figured out?
* How many rows have you already collected? How many rows do you want to collect? How many rows would you collect in a perfect world?
* Is collecting the data part of the "data science" aspect of your project?
* What is the single biggest hurdle right now in terms of gathering the data? How are you going to manage that hurdle?
* What are the most important aspects of the data? That is, what does the data help answer about the research question?
